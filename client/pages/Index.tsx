    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 py-4 flex items-center justify-between">
          <div className="text-xl font-light tracking-tight">Portfolio</div>
      ...
      {/* Hero Section */}
      <section className="max-w-6xl mx-auto px-6 sm:px-8 py-24 sm:py-32 animate-fade-in">
      ...
      <section id="projects" className="max-w-6xl mx-auto px-6 sm:px-8 py-24 sm:py-32">
      ...
      {/* Footer */}
      <footer className="max-w-6xl mx-auto px-6 sm:px-8 py-16 border-t border-border">
