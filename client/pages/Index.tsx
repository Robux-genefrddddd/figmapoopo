    ...
    <>
        ...
        <SidebarContent className="px-0">
          <SidebarMenu className="gap-1 px-2">
            <SidebarMenuItem>
              <a
                href="#"
                className="flex items-center px-4 py-3 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-all duration-300"
              >
                Home
              </a>
            </SidebarMenuItem>
            ...
            <SidebarMenuItem>
              <button className="w-full text-left px-4 py-3 rounded-lg text-sm text-background bg-foreground font-medium hover:opacity-90 transition-all duration-300">
                Contact
              </button>
            </SidebarMenuItem>
          </SidebarMenu>
      ...
      <SidebarInset>
        <div className="min-h-screen bg-background">
          ...
          {/* Hero Section */}
          <section className="px-4 sm:px-6 py-24 sm:py-32 animate-fade-in">
            ...
            {/* Hero Visual Element */}
            <div className="mt-20 sm:mt-28 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* About Section */}
          <section id="about" className="px-4 sm:px-6 py-24 sm:py-32">
          ...
          {/* Footer */}
          <footer className="px-4 sm:px-6 py-16 border-t border-border">
